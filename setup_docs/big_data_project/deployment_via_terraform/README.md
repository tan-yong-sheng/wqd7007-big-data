...
> Please refer to the [Terraform Resource Configuration documentation](/setup_docs/big_data_prpject/deployment_via_terraform/README.md) to understand which big data infrastructure components are automatically provisioned via Terraform.
