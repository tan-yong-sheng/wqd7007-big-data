...
# DAG definition
with DAG("SparkETL-v2", schedule_interval="@weekly", default_args=default_args) as dag:
    ...
    download_data >> create_staging_table >> create_batch >> list_batches >> get_batch >> delete_batch >> create_fact_table >> upsert_data
